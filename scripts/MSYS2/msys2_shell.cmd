...
:: To activate windows native symlinks uncomment the next line
:: set MSYS=winsymlinks:nativestrict

:: Set debugging program for errors
:: set MSYS=error_start:%WD%../../mingw64/bin/qtcreator.exe^|-debug^|^<process-id^>
...
if "x%~1" == "x-where" (
  ...
  :: Ensure parentheses in argument do not interfere with FOR IN loop below.
  set msys2_arg="%~2"
